...
const AllItems = ({ data }) => {
  ...
  &#8377;{" "}
  {(Number(e.card.info?.price || e.card.info?.variantsV2?.pricingModels[0]?.price || 0) / 100)
    .toLocaleString("en-IN", { style: "decimal", minimumFractionDigits: 2, maximumFractionDigits: 2 })}
</h3>
                        ...
                        <span className="block text-[14px] max-w-[700px] ">
                      ...
                      <div className="relative">
                        ...
                        <button className="block bg-white text-green-500 font-bold border rounded-lg px-[20px] py-[5px] ml-[35px] absolute bottom-7">
                          ADD
                        </button>

                        <span className="mt-[30px] ml-[35px] absolute text-[12px] bottom-2 ">
                          Customisable
                        </span>
                      </div>
                    </div>
